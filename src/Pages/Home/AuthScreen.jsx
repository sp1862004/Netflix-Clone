...
const AuthScreen = () => {
    ...
    return (
        <div className='hero-bg relative'>
            ...
            {/* Navbar */}
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-5'>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
                    ...
                    />
                    <button className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-1 rounded flex justify-center items-center'>
                        Get Started
            ...
            <div className='py-8 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 text-center md:text-left'>
                        <h3 className='text-4xl md:text-5xl font-extrabold mb-4'>Enjoy on your TV</h3>
                    ...
                    <div className='flex-1 relative'>
                        <img src='/tv.png' alt='Tv image' className='mt-3 z-20 relative' />
                        <video
  ...
  '
                            >
                                ...
                                <div className=' flex justify-between items-center w-full'>
                                    ...
                                    <img src='/download-icon.gif' alt='' className='h-9' />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex-1 md:text-left text-center'>
                        <h3 className='text-4xl md:text-5xl font-extrabold mb-4 text-balance'>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    {/* left  */}
                    <div className='flex-1 text-center md:text-left'>
                        <h3 className='text-4xl md:text-5xl font-extrabold mb-4'>Watch everywhere</h3>
                        <p className='text-lg md:text-xl'>
  ...
  '
        ...
        '
                >
                    ...
                    {/* right */}
                    <div className='flex-1 text-center md:text-left'>
                        <h3 className='text-4xl md:text-5xl font-extrabold mb-4'>Create profiles for kids</h3>
                        <p className='text-lg md:text-xl'>
